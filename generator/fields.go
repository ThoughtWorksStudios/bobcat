...
type FieldType interface {
	Type() string
	One(parentId string, emitter Emitter, previousValues []interface{}) interface{}
...
func (field *ReferenceType) One(parentId string, emitter Emitter, previousValues []interface{}) interface{} {
...
func (field *EntityType) One(parentId string, emitter Emitter, previousValues []interface{}) interface{} {
	return field.entityGenerator.One(parentId, emitter)
}
...
func (field *BoolType) One(parentId string, emitter Emitter, previousValues []interface{}) interface{} {
...
func (field *MongoIDType) One(parentId string, emitter Emitter, previousValues []interface{}) interface{} {
...
func (field *LiteralType) One(parentId string, emitter Emitter, previousValues []interface{}) interface{} {
	return field.value
}
...
func (field *StringType) One(parentId string, emitter Emitter, previousValues []interface{}) interface{} {
	n := field.length
	b := make([]byte, n)
...
func (field *IntegerType) One(parentId string, emitter Emitter, previousValues []interface{}) interface{} {
...
func (field *FloatType) One(parentId string, emitter Emitter, previousValues []interface{}) interface{} {
...
func (field *DateType) One(parentId string, emitter Emitter, previousValues []interface{}) interface{} {
...
func (field *DictType) One(parentId string, emitter Emitter, previousValues []interface{}) interface{} {
...
func (field *EnumType) One(parentId string, emitter Emitter, previousValues []interface{}) interface{} {
